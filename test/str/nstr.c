...
void check_slice(const char_t * func, nstr_p s, int32_t need_free, int32_t bytes, int32_t chars, str_encoding_t encoding, const char_t * start, entity_p ent, int32_t slcs)
{
...
Test(Creation, nstr_new_reference)
{
    ...
    check_slice((const char_t *)"nstr_new_reference", new, 1, size, size, STR_ENC_ASCII, cstr, &ref_ent, 1);
