...
// 生成片段引用，或生成新字符串（字符范围）
extern nstr_p nstr_slice_chars(nstr_p s, bool no_ref, uint32_t index, uint32_t chars);

// 生成片段引用，或生成新字符串（字节范围）
extern nstr_p nstr_slice_bytes(nstr_p s, bool no_ref, void * pos, uint32_t bytes);
